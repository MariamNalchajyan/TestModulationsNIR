...
// TestModulations.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestModulationsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTestModulationsApp

CTestModulationsApp::CTestModulationsApp()
{
...
// Единственный объект CTestModulationsApp

CTestModulationsApp theApp;


// Инициализация CTestModulationsApp

BOOL CTestModulationsApp::InitInstance()
{
